...
class Pymix:
    ...
    def __init__(self,pathcalm='musicologie/musiques/calme/',pathanger='D:/Projet_E3/IA_Music/musicologie/musiques/colere/',pathjoy='musicologie/musiques/joyeux/',pathsad='musicologie/musiques/triste/'):
