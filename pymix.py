...
class Pymix:
    ...
    def __init__(self,pathjoy='musicologie/musiques/joyeux/',pathanger='D:/Projet_E3/IA_Music/musicologie/musiques/colere/',pathcalm='musicologie/musiques/calme/',pathsad='musicologie/musiques/triste/'):
